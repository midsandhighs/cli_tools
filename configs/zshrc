...
export ZSH="/Users/jonathan.haenchen/.oh-my-zsh"
...
#
alias ls='ls -lFGha'
#alias muxkill='tmux ls | grep : | cut -d. -f1 | awk "{print substr($1, 0, length($1)-1)}" | xargs kill'
alias testkitchen='mosh fa-testkitchen'
alias :q='exit'
